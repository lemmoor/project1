  ...
  return (
    <>
      <main className="container p-4 my-4">
        ...
        <ul className="list-decimal ml-4">
          ...
          <li className="pl-1 mt-2">
            ...
            <p className="text-info-content italic pl-2">
              After working as a graphic designer for several years, Jane
              decided to add another string to her bow and took a course in web
              development.
            </p>
          </li>
          <li className="pl-1 mt-2">
          ...
          <li className="pl-1 mt-2">
            ...
            <p className="text-info-content italic pl-2">
              I know some people love spicy food, but it&apos;s just not my cup
              of tea.
            </p>
          </li>
          <li className="pl-1 mt-2">
        ...
        <ul className="list-decimal ml-4">
          <li className="pl-1 mt-2">
            ...
            <p className="text-info-content italic pl-2">
              Before presenting the proposal to the investors, we need to get
              our ducks in a row and make sure all the details are sorted out.
            </p>
          </li>
          <li className="pl-1 mt-2">
          ...
          <li className="pl-1 mt-2">
            ...
            <p className="text-info-content italic pl-2">
              When a new trend emerges, people are quick to jump on the
              bandwagon and try it out.
            </p>
          </li>
          <li className="pl-1 mt-2">
      ...
      <Footer
        sourcesLinks={[
          {
            title: 'YourDictionary - British idioms',
            link: 'https://examples.yourdictionary.com/articles/common-british-sayings.html',
          },
          {
            link: 'https://examples.yourdictionary.com/100-american-idioms-popular-us-expressions-explained',
            title: 'YourDictionary - American idioms',
          },
          {
            link: 'https://www.diki.pl/',
            title: 'Diki',
          },
        ]}
      />
