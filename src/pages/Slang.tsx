    ...
    <>
      <main className="container p-4 my-4">
        ...
        <ul className="list-decimal ml-4">
          ...
          <li className="pl-1 mt-2">
            ...
            <p className="text-info-content italic pl-2">
              The handyman botched the repair job, and I had to call someone
              else to fix it.
            </p>
          </li>
          <li className="pl-1 mt-2">
        ...
        <ul className="list-decimal ml-4">
          ...
          <li className="pl-1 mt-2">
            ...
            <p className="text-info-content italic pl-2">
              I&apos;m sorry, I zoned out during that meeting. Can you repeat
              what you said?
            </p>
          </li>
          <li className="pl-1 mt-2">
          ...
          <li className="pl-1 mt-2">
            ...
            <p className="text-info-content italic pl-2">
              The group of friends made plans to go hiking, but one of them had
              to ditch at the last minute due to work.
            </p>
          </li>
          <li className="pl-1 mt-2">
      ...
      <Footer
        sourcesLinks={[
          {
            title: 'Shorelight',
            link: 'https://shorelight.com/student-stories/a-guide-to-american-college-slang-words-in-2023/',
          },
          {
          ...
          {
            link: 'https://www.berlitz.com/blog/american-slang-words',
            title: 'Berlitz',
          },
          {
            link: 'https://www.british-study.com/en/blog/british-slang-words/',
